...
def test_fish_completion_simple_positional(capfd):
    ...
    assert "auto-generated by tinycli" in completion
...
def test_fish_completion_nocomplete_positional(capfd):
    @tinycli.command
    def foo(value: tinycli.NoComplete[str], /):
        return value
...
def test_fish_completion_option_dir(capfd):
    @tinycli.command
    def foo(*, file: tinycli.Dir[str, "/tmp"]):
        return file
...
def test_fish_completion_union_with_nocomplete(capfd):
    @tinycli.command
    def foo(*, value: Literal["a", "b"] | tinycli.NoComplete[int]):
        return value
...
def test_fish_completion_dir_with_path(capfd):
    @tinycli.command
    def foo(*, file: tinycli.Dir[pathlib.Path, "/var/log"]):
        return file
...
def test_fish_completion_union_dir(capfd):
    @tinycli.command
    def foo(*, value: tinycli.Dir[str, "."] | tinycli.Dir[str, "/tmp"]):
        return value
...
def test_fish_completion_dir_str_option(capfd):
    @tinycli.command
    def foo(*, file: tinycli.Dir[str]):  # pyright: ignore[reportInvalidTypeForm]
        return file
...
def test_fish_completion_dir_path_option(capfd):
    @tinycli.command
    def foo(*, file: tinycli.Dir[pathlib.Path]):  # pyright: ignore[reportInvalidTypeForm]
        return file
...
def test_fish_completion_with_help(capfd):
    @tinycli.command(
        help=tinycli.Help("Test help", tinycli.Style(), dict(verbose="bar"), {})
    )
...
def test_fish_completion_with_help_and_version(capfd):
    @tinycli.command(
        help=tinycli.Help("Test help", tinycli.Style(), dict(quiet="qasdf"), {}),
        version="2.0.0",
    )
...
def test_fish_completion_help_with_subcommand(capfd):
    @tinycli.command(
        help=tinycli.Help(
            "Test help", tinycli.Style(), dict(force="whether to force"), {}
        )
    )
...
def test_fish_completion_help_no_conflict_with_host(capfd):
    ...
    @tinycli.command(
        help=tinycli.Help(
            "Test", tinycli.Style(), dict(host="the host"), dict(host="host")
        )
    )
